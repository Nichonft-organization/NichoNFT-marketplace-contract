...
contract CreatorNFT is ERC721URIStorage {
    ...
    function mint(string memory _tokenUri) public {
        // if this collection contract is not belong to creator, stop minting
        if (msg.sender != owner) revert CreatorNFT__InvalidCreator();
     ...
     *        _amount -> how many items to mint
     */
    function batchIDMint(string calldata _baseTokenUri, uint _amount)
        external
        validAmount(_amount)
    {
        // mint for creator
